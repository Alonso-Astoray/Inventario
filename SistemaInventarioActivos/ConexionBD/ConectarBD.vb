...
Module ConectarBD
    ...
    Public Sub establecerconexion()
        Try
            ...
            Else
                conexion = New SqlConnection("Data Source= " & ip.Trim & "; Initial Catalog=" & bd.Trim & "; User Id=" & ip.Trim & "; Password = " & pass.Trim & "; ")
            End If
    ...
    Public Function obtenerconexion() As String
        ...
        Try
            ...
            If ip.Length = 0 Or user.Length = 0 Or pass.Length = 0 Or bd.Length = 0 Then
                MsgBox("Faltan parametros de conexión", vbCritical, "ERROR DE CONEXIÓN")
            Else
                miconexion = "Data Source= " & ip.Trim & "; Initial Catalog=" & bd.Trim & "; User Id=" & ip.Trim & "; Password = " & pass.Trim & "; "
            End If
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Critical)
        End Try
